import type { Investor as BaseInvestor, WarmthTier } from "@/app/data/mockData";

// Extend locally to allow optional contact fields without changing shared types
type Investor = BaseInvestor & {
