...
export const MOCK_PORTFOLIO_COMPANIES: MockPortfolioCompany[] = [
  ...
  {
    id: "mock-pc-koop-technologies",
    name: "Koop Technologies",
  ...
  },
  {
    ...
    name: "Earth Force",
    website: "https://www.earthforce.io",
    status: "active",
  },
  { id: "mock-pc-aon-3d", name: "Aon 3D", website: "https://www.aon3d.com", status: "active" },
  {
    id: "mock-pc-avatar",
    name: "Avatar",
    website: "https://www.avatarsystems.com",
    status: "active",
  },
  {
    id: "mock-pc-root-access",
    name: "Root Access",
    website: "https://www.rootaccess.ai",
    status: "active",
  },
  {
    id: "mock-pc-halo-braid",
    name: "Halo Braid",
    website: "https://www.halobraid.com",
    status: "active",
  },
  { id: "mock-pc-dolagon", name: "dolaGon", website: "https://www.dolagon.com", status: "active" },
  {
    id: "mock-pc-arix-technologies",
    name: "ARIX Technologies",
    website: "https://www.arix-tech.com",
    status: "active",
  },
  {
    id: "mock-pc-spaero-bio",
    name: "Spaero Bio",
    website: "https://www.spaero.bio",
    status: "alumni",
  },
  {
    id: "mock-pc-dexai-robotics",
    name: "Dexai Robotics",
    website: "https://www.dexai.com",
    status: "alumni",
  },
