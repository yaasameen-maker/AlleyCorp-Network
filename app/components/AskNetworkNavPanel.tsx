      ...
      <form onSubmit={handleSubmit} className="space-y-2">
        <div className="relative">
          <input
            ...
            className="w-full pl-3 pr-9 py-2.5 bg-paper border border-line rounded-xl text-sm text-ink placeholder-muted focus:outline-none focus:ring-2 focus:ring-ink/20"
          />
          {query ? (
            <button
              type="button"
          ...
          <button
            ...
            className="absolute right-1 top-1/2 -translate-y-1/2 flex items-center justify-center w-7 h-7 rounded-lg bg-ink text-paper"
          >
            <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden>
